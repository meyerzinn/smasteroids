packr
GOOS=darwin GOARCH=amd64 CGO_ENABLED=1 go build -ldflags "-X gitlab.com/meyerzinn/smasteroids/smasteroids.version=$(git describe)" -o dist/mac/SMasteroids.app/Contents/MacOS/smasteroids gitlab.com/meyerzinn/smasteroids
